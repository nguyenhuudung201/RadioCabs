...
import { CompanyProfileDetail } from "../../model/CompanyProfile";
import { MdOutlineEmail } from "react-icons/md";
import { FaPhoneAlt } from "react-icons/fa";
import { IoIosContact } from "react-icons/io";
import moment from "moment";
const ProfileCompanyDetail = () => {
  const [profile, setProfile] = useState<CompanyProfileDetail>();
  const { id } = useParams();
  useEffect(() => {
    axios
      .get(`${BackendUrl}/ProfileCompany/${id}`, {
        headers: {
            ...
            <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
              <div className="col-span-4 sm:col-span-3">
                <div className="bg-white shadow rounded-lg p-6">
                  ...
                  <div className="flex flex-col">
                    ...
                    <ul>
                      <li className="mb-2 flex ">Fax:{profile?.fax}</li>
                      <li className="mb-2 flex ">
                        Designation:{profile?.designation}
                      </li>
                      <li className="mb-2 flex ">Address:{profile?.address}</li>
                      <li className="mb-2 flex ">
                        DateOfBirth:
              ...
              <div className="col-span-4 sm:col-span-9">
                <div className="bg-white shadow rounded-lg p-6">
                  ...
                  <h2 className="text-xl font-bold my-4">Services</h2>
